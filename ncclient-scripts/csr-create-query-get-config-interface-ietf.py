...
if len(sys.argv) < 2:
    ...
    print('Usage: python3 csr-create-query-get-config-interface-ietf.py <container_name> [<interface_name>]')
    print('Example for the GigabitEthernet1 interface: python3 csr-create-query-get-config-interface-ietf.py clab-telemetry-testbed-r1 GigabitEthernet1')
    print('Example for all interfaces: python3 csr-create-query-get-config-interface-ietf.py clab-telemetry-testbed-r1')
    exit(1)
else:
