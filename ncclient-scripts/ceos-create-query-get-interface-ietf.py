...
if len(sys.argv) < 2:
    ...
    print('Usage: python3 ceos-create-query-get-interface.py <container_name> [<interface_name>]')
    print('Example for the Ethernet1 interface: python3 ceos-create-query-get-interface-ietf.py clab-telemetry-testbed-xe-ceos-r2 Ethernet1')
    print('Example for all interfaces: python3 ceos-create-query-get-interface-ietf.py clab-telemetry-testbed-xe-ceos-r2')
    exit(1)
else:
...
reply = session.get(filter=("subtree", interface_config_rendered))
