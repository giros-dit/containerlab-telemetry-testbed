...
```
$ python3 csr-r1-create-subscription.py <XPath> <subscription-type> [<period_in_ms>]
```

> **Peridic subscription example:**
> 
>```
>python3 csr-r1-create-subscription.py "/interfaces-state/interface[name=\'GigabitEthernet2\']" periodic 1000
>```
 
> **On-change subscription example:**
> 
>```
>python3 csr-r1-create-subscription.py "/native/hostname" onchange
>```
